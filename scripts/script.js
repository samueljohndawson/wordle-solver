...
function submitGuess() {
    ...
    if (document.getElementById('inputBox').value.length !== 5) {
        alert("Woops! Looks like a typo! Please enter a five letter word");
        clearAll()
        return;
    }
    ...
    // logic that updates letter lists
    ...
    words = words.filter(checkLetterPositions);
    words = words.filter(checkLetterNotPositions);
...
// logic for clicking the color buttons
function changeColor(button) {
    switch (button.style.backgroundColor) {
        case 'rgb(120, 124, 126)':
            button.style.backgroundColor = 'rgb(201, 180, 88)';
            break;
        case 'rgb(201, 180, 88)':
            button.style.backgroundColor = 'rgb(106, 170, 100)';
            break;
...
// Logic for filtering the word list
function checkLettersNotInWord(word) {
    for (let letter of word) {
        if (lettersNotInWord.has(letter)) {
            return false;
        } 
    }
    return true;
...
function checkLetterPositions(word) {
    for (let position in letterPositions) {
        if (word.charAt(position) !== letterPositions[position]) {
            return false;
        }
    }
    return true;
...
function checkLetterNotPositions(word) {
    for (let position in letterNotPositions) {
        if (word.charAt(position) === letterNotPositions[position]) {
            return false;
        }
    }
    return true;
...
function checkLettersInWord(word) {
...
function checkLetterCountLimits(word) {
    for (let letter in letterCountLimits) {
        let re = new RegExp(letter,"g");
        if (letterCountLimits[letter] < (word.match(re).length)) {
            return false
        }
    }
    return true
...
function resetColors() {
    colorButton1.style.backgroundColor = 'rgb(120, 124, 126)'
    colorButton2.style.backgroundColor = 'rgb(120, 124, 126)'
    colorButton3.style.backgroundColor = 'rgb(120, 124, 126)'
    colorButton4.style.backgroundColor = 'rgb(120, 124, 126)'
    colorButton5.style.backgroundColor = 'rgb(120, 124, 126)'
}
